...
# Task 02
transaction4 = blockchain.transaction("mike", "satoshi", '2 ETH')
transaction5 = blockchain.transaction("Hal Finney", "Satoshi", '3 ETH')
transaction6 = blockchain.transaction("Satoshi", "Hal Finney", '5 ETH')
